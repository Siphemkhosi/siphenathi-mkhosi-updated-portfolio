         ...
         <div className={classes.Section3}>
           ...
           <div className={classes.divider}></div>
            <Carousel responsive={responsive} 
             >
            <div>
            <Card  info={{name:"odin-landingPage", path:"https:siphemkhosi.github.io/odin-landingPage/", details:"info about info", image:dog, typeOfApp:"web application"}} />             <Card  info={{name:"girl-code-challenge", path:"https:siphemkhosi.github.io/girlcode-challenge/", details:"info about info", image:gbv, typeOfApp:"web application"}} />
